...
import { MaintenanceEvent } from "../../../types/assets";
import { Calendar, Wrench, Clock } from "lucide-react";

interface MaintenanceTimelineSectionProps {
  timeline: MaintenanceEvent[];
}

export const MaintenanceTimelineSection: React.FC<MaintenanceTimelineSectionProps> = ({ timeline }) => {
...
export default MaintenanceTimelineSection;
