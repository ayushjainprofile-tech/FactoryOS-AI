...
export const DocumentIndexedWidget: React.FC = () => {
  ...
  const failed = documents.filter((d) => d.status.endsWith("failed") || d.status === "failed").length;
...
export default DocumentIndexedWidget;
